          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              <div class="d-flex justify-content-center py-4">
                <a class="logo d-flex align-items-center w-auto gap-1">
                  <img src="./assets/img/logo.png">
                  <span class="d-none d-lg-block">Login SiGudang</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <form class="row g-3 pt-4 needs-validation" novalidate action="./Controllers/AuthControllers.php" method="POST">
                    <div class="col-12">
                      <label for="yourEmailOrUsername" class="form-label">Email atau Username</label>
                      <div class="input-group has-validation">
                        <input type="text" name="usernameOrEmail" class="form-control" id="yourEmailOrUsername" required placeholder="Email atau Username">
                        <div class="invalid-feedback">Harap masukkan Email atau Username.</div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Belum Punya Akun? <a href="register.php">Buat Akun Disini.</a></p>
                    </div>
                  </form>
                </div>
              </div>
